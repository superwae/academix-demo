// TODO: Deprecated legacy shim — not imported anywhere. Replaced by components/layouts/TeacherLayout.tsx.
...
export function TeacherLayout() {
  ...
  return (
    <div className="relative min-h-dvh bg-background text-foreground">
            ...
            <Dialog open={mobileOpen} onOpenChange={setMobileOpen}>
              ...
              <DialogContent className="max-w-sm p-0">
                ...
                <div className="px-4 pb-4 pt-2">
                  <TeacherNavList onNavigate={() => setMobileOpen(false)} />
                </div>
              </DialogContent>
            </Dialog>
      ...
      {/* Main Layout Grid */}
      <div className="mx-auto grid max-w-[1920px] grid-cols-1 gap-4 px-4 py-4 sm:gap-6 sm:px-6 sm:py-6 lg:grid-cols-[280px_1fr] lg:gap-8 lg:px-6 lg:py-8">
        {/* Premium Sidebar */}
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="mt-0.5 truncate text-base font-bold">
                    {user ? `${user.firstName} ${user.lastName}` : "Dr. Sarah Johnson"}
                  </div>
        ...
        <main id="main-content" className="min-w-0" role="main" tabIndex={-1}>
          <motion.div
            ...
            className="glass-strong rounded-2xl border border-border/60 p-6 shadow-xl md:p-8"
          >
            <Outlet />
          </motion.div>
        </main>
...
function TeacherNavList({ onNavigate }: { onNavigate?: () => void }) {
  return (
