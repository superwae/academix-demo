    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SectionMeetingTimes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SectionMeetingTimes_CourseSections_SectionId",
                        column: x => x.SectionId,
                        principalTable: "CourseSections",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnswersJson = table.Column<string>(type: "character varying(5000)", maxLength: 5000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChoicesJson = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseTags_CourseId_TagId",
                table: "CourseTags",
