        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxSeatsPerCourse = table.Column<int>(type: "integer", nullable: true),
                    MaxTotalSeats = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LahzaSubscriptionCode = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    LahzaCustomerCode = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LahzaReference = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    LahzaAuthorizationCode = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    LahzaChannel = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    PaidAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CourseId = table.Column<Guid>(type: "uuid", nullable: true),
                    SubscriptionId = table.Column<Guid>(type: "uuid", nullable: true),
                    DiscountId = table.Column<Guid>(type: "uuid", nullable: true),
                    OriginalAmount = table.Column<long>(type: "bigint", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CreatedBy = table.Column<Guid>(type: "uuid", nullable: true),
                    UpdatedBy = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Discounts_CourseId_Code",
                table: "Discounts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_LahzaReference",
                table: "Payments",
                column: "LahzaReference",
                unique: true,
                filter: "\"LahzaReference\" IS NOT NULL");
