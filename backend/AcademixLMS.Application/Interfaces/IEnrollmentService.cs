...
public interface IEnrollmentService
{
    ...
    Task<Result<PagedResult<EnrollmentDto>>> GetPagedAsync(PagedRequest request, CancellationToken cancellationToken = default);
    ...
    Task<Result<EnrollmentDto>> SwitchSectionAsync(Guid enrollmentId, Guid newSectionId, Guid userId, bool isAdmin = false, CancellationToken cancellationToken = default);
