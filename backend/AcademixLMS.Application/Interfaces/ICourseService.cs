...
public interface ICourseService
{
    ...
    Task<Result<CourseDto>> GetByIdForUserAsync(Guid id, Guid? userId, bool isAdmin, CancellationToken cancellationToken = default);
    ...
    Task<Result> DeleteAsync(Guid id, Guid? requestingUserId = null, bool isAdmin = true, CancellationToken cancellationToken = default);
    Task<Result> PublishAsync(Guid id, Guid? requestingUserId = null, bool isAdmin = true, CancellationToken cancellationToken = default);
    Task<Result> ArchiveAsync(Guid id, Guid? requestingUserId = null, bool isAdmin = true, CancellationToken cancellationToken = default);
