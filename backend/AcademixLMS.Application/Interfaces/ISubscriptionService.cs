...
public interface ISubscriptionService
{
    ...
    Task<Result<SubscriptionStatusDto>> GetSubscriptionStatusAsync(Guid userId, Guid? organizationId = null, bool forcePersonal = false, CancellationToken cancellationToken = default);
    ...
    Task<Result<SubscriptionDto>> SubscribeOrganizationAsync(Guid requestingUserId, Guid organizationId, Guid planId, BillingInterval billingInterval, CancellationToken cancellationToken = default);
